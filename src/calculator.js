let calculateScienceScoreFn;

if (typeof module !== 'undefined' && module.exports) {
    ({ calculateScienceScore: calculateScienceScoreFn } = require('./science.js'));
} else if (typeof window !== 'undefined' && window.SevenWondersScoring) {
    ({ calculateScienceScore: calculateScienceScoreFn } = window.SevenWondersScoring);
} else {
    throw new Error('calculateScienceScore dependency not found');
}
...
Thanks!`);
    ...
    calculateScienceScore(scienceGear, scienceMason, scienceScript, scienceFree) {
        return calculateScienceScoreFn(scienceGear, scienceMason, scienceScript, scienceFree);
    }
...
if (typeof module !== 'undefined' && module.exports) {
    ...
    window.SevenWondersCalculator = SevenWondersCalculator;
}
